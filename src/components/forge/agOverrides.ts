/**
 * Manual grid position overrides extracted from EFTForge attachment-grid.js
 * Key format: slotId@parentItemId -> { col, vrow, flexible }
 */
export interface OverrideEntry { col: number; vrow: number; flexible?: boolean }
export const AG_OVERRIDES: Record<string, OverrideEntry> = {
    ...
    // Special: duplicate slot on same parent uses #1 suffix in original EFTForge
    ...
    // DUP: "62811fbf09427b40ab14e76b@62811fbf09427b40ab14e767": { col: 9, vrow: -1 },
    ...
    // DUP: "6357cd4b6bd1f226843c249f@55d3632e4bdc2d972f8b4569": { col: 6, vrow: 1, flexible: true },
    ...
    // DUP: "68c170e383e2d814b0093f8d@68c170e383e2d814b0093f87": { col: 5, vrow: -1, flexible: true },
    "68c2989dc9061bb2f50478fb@68c2989dc9061bb2f50478f6": { col: 4, vrow: -1, flexible: true },
    // DUP: "68c2989dc9061bb2f50478fc@68c2989dc9061bb2f50478f6": { col: 5, vrow: -1, flexible: true },
}
